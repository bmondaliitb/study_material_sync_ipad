...
Bool_t MyAnalysis::Process(Long64_t entry) {
   ...
   //***************************************************************** 
     ...
     //Calc. of Br. of electrons 
     if(MCleptonPDGid == 11 || MCleptonPDGid == -11){
        ++N_Electron;
     }
 
     //Calc. of Br. of muons                <================================= 
     if(MCleptonPDGid == 13 || MCleptonPDGid == -13){
        ++N_Muon;
     }
     //Fiducial region 
   ...
   //**********************************************************  
     ...
     //pT of electrons 
     if(MCleptonPDGid == 11 || MCleptonPDGid == -11){
        h_Electron_Pt->Fill(lepWl.Pt());
     }
 
     //pT of muons    
     if(MCleptonPDGid == 13 || MCleptonPDGid == -13){
        h_Muon_Pt->Fill(lepWl.Pt());
     }
   ...
   //**********************************************************  
     ...
     h_Ptleptop->Fill((lepWl + lepWn + lepB).Pt());
     h_Mhadtop->Fill((hadWq + hadWqb + hadB).M()); 
     h_Mleptop->Fill((lepWl + lepWn + lepB).M());
