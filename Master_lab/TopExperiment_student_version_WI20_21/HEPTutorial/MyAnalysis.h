...
public:
   ...
   float TotalEvents, N_Electron, N_Muon, N_GenFid, N_Tau, trig_cut, NMuon_cut, MuonIso_cut, OneMuonPt_cut, TrueJet_cut, NJet_cut, btag_cut, met_cut, FinalWeightedNEvent, PassFiducialNSelection;
...
void MyAnalysis::Init(TTree *tree)
{
   ...
   btag_cut = 0;
   met_cut = 0;
   FinalWeightedNEvent= 0;
   PassFiducialNSelection= 0;
}
